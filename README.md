<p align="center">
  <img src="resources/logo.png" alt="OSMOS — See · Understand · Assist" width="360" />
</p>
...
| **Agents** | Per-profile agent identity, system prompt, skills, MCP connectors, and optional provider/model override |
| **Chat** | Streaming LLM replies with markdown rendering + cancel; Ollama local or OpenAI / Anthropic / Groq / OpenRouter / LiteLLM |
...
5. Optionally configure the profile **Agent** (skills, MCP connectors, provider override).
...
| **Agents** | Per-profile skills, MCP connectors, custom system prompt, provider/model override |
...
| **Low-profile** | Hide from screen capture where the OS allows |
